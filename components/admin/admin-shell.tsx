...
import { AdminAppearanceProvider } from "@/components/admin/admin-appearance-provider";
import { cn } from "@/lib/utils";

const NAV = [
  { label: "Overview", href: "/admin", icon: LayoutDashboard },
  { label: "Posters & Banners", href: "/admin/posters", icon: ImageIcon },
        ...
        >
          ...
          <div className="border-t p-3" style={{ borderColor: "hsl(var(--border))" }}>
            <button
              ...
              className="flex w-full cursor-pointer items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium transition-colors hover:opacity-80"
